...
class Instagram_data:
    ...
    def __init__(self, version="14", adb_name="R5CX933925Y", target=10, searchtag="platacard"):
...
if __name__ == "__main__":
    print("Inicializando conexión con Appium...")
    bot = Instagram_data(
        version="14",                 # Asegúrate de que esta versión sea la de tu teléfono
        adb_name="R5CX933925Y",      # Verificado con adb devices
        target=5,                     # Cantidad de perfiles a extraer
        searchtag="platacard"
    )
    print("Bot inicializado. Ejecutando scraping...")
    bot.dataframe()
    print("Proceso finalizado. Archivo leads.xlsx generado.")
